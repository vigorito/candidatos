...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { post_id: @comentario.post_id, texto: @comentario.texto, user_id: @comentario.user_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { post_id: @comentario.post_id, texto: @comentario.texto, user_id: @comentario.user_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
